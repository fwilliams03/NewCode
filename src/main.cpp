...
Conveyor.spin(forward, 100, velocityUnits::pct); //grab goal  
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, 1.02, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 1.02, rotationUnits::rev, 35,velocityUnits::pct);    //turn right
 BackRightBase.startRotateFor(directionType::rev, 1.02, rotationUnits::rev, 35, velocityUnits::pct);
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .75, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .75, rotationUnits::rev, 35,velocityUnits::pct);    //turn right
 BackRightBase.startRotateFor(directionType::rev, .75, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .75, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::fwd, 2.6, rotationUnits::rev, 40,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 2.6, rotationUnits::rev, 40,velocityUnits::pct);  //drive forward for red goal 
 BackRightBase.startRotateFor(directionType::fwd, 2.6, rotationUnits::rev, 40, velocityUnits::pct);
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .65, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .65, rotationUnits::rev, 35,velocityUnits::pct);    //turn right
 BackRightBase.startRotateFor(directionType::rev, .65, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .65, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::fwd, 1, rotationUnits::rev, 35,  velocityUnits::pct);
