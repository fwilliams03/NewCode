...
Conveyor.spin(forward, 100, velocityUnits::pct); //grab goal  
 ...
 Conveyor.stop();
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .39, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .39, rotationUnits::rev, 35,velocityUnits::pct);    //turn left towards red goal
 BackRightBase.startRotateFor(directionType::rev, .39, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .39, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
...
/*
 ...
 BackLeftBase.rotateFor(directionType::fwd, 1, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .987, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .987, rotationUnits::rev, 35,velocityUnits::pct);
 BackRightBase.startRotateFor(directionType::rev, .987, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .987, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 Claw.spin(directionType::rev,100, velocityUnits::pct);
 vex::task::sleep(300);
 Claw.stop();
