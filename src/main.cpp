...
FrontRightBase.startRotateFor(directionType::rev, .55, rotationUnits::rev, 35,  velocityUnits::pct);
 ...
 vex::task::sleep(200);
 FrontRightBase.startRotateFor(directionType::rev, 1, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::rev, 1, rotationUnits::rev, 35,velocityUnits::pct);    //drive to neutral goal
 BackRightBase.startRotateFor(directionType::rev, 1, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::rev, 1, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(200);
*/
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .990, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .990, rotationUnits::rev, 35,velocityUnits::pct);
 BackRightBase.startRotateFor(directionType::rev, .990, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .990, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(200);
 Claw.spin(directionType::rev,100, velocityUnits::pct);
 vex::task::sleep(200);
 Claw.stop();
 vex::task::sleep(600);
 FrontRightBase.startRotateFor(directionType::fwd, 2.47, rotationUnits::rev, 70,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 2.47, rotationUnits::rev, 70,velocityUnits::pct);
 BackRightBase.startRotateFor(directionType::fwd, 2.47, rotationUnits::rev, 70, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, 2.47, rotationUnits::rev, 70,velocityUnits::pct);
 vex::task::sleep(600);
 Claw.spin(directionType::fwd,100, velocityUnits::pct);
 vex::task::sleep(300);
 Claw.stop(hold);
