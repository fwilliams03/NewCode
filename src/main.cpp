...
*/ 
 ...
 Claw.stop();
 vex::task::sleep(600);
 FrontRightBase.startRotateFor(directionType::fwd, 2.49, rotationUnits::rev, 70,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 2.49, rotationUnits::rev, 70,velocityUnits::pct);
 BackRightBase.startRotateFor(directionType::fwd, 2.49, rotationUnits::rev, 70, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, 2.49, rotationUnits::rev, 70,velocityUnits::pct);
 vex::task::sleep(600);
 Claw.spin(directionType::fwd,100, velocityUnits::pct);
 vex::task::sleep(300);
 Claw.stop(hold);
