...
Conveyor.spin(forward, 100, velocityUnits::pct); //grab goal  
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, 1.07, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 1.07, rotationUnits::rev, 35,velocityUnits::pct);    //turn right
 BackRightBase.startRotateFor(directionType::rev, 1.07, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, 1.07, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 ...
 vex::task::sleep(800);
 FrontRightBase.startRotateFor(directionType::rev, .2, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .2, rotationUnits::rev, 35,velocityUnits::pct);    //turn right
 BackRightBase.startRotateFor(directionType::rev, .2, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .2, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::fwd, 3, rotationUnits::rev, 40,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 3, rotationUnits::rev, 40,velocityUnits::pct);    //drive forward
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::fwd, .14, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::rev, .14, rotationUnits::rev, 35,velocityUnits::pct);
 BackRightBase.startRotateFor(directionType::fwd, .14, rotationUnits::rev, 35, velocityUnits::pct); //little to the left
 BackLeftBase.rotateFor(directionType::rev, .14, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
 ...
 Conveyor.stop();
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .368, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .368, rotationUnits::rev, 35,velocityUnits::pct);    //turn left towards red goal
 BackRightBase.startRotateFor(directionType::rev, .368, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .368, rotationUnits::rev, 35,velocityUnits::pct);
 vex::task::sleep(500);
