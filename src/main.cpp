...
Conveyor.spin(forward, 100, velocityUnits::pct); //grab goal  
 ...
 vex::task::sleep(500);
 FrontRightBase.startRotateFor(directionType::rev, .9, rotationUnits::rev, 35,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, .9, rotationUnits::rev, 35,velocityUnits::pct);    //turn right
 BackRightBase.startRotateFor(directionType::rev, .9, rotationUnits::rev, 35, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, .9, rotationUnits::rev, 35,velocityUnits::pct);
