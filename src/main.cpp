...
*/
 ...
 Claw.stop();
 vex::task::sleep(600);
 FrontRightBase.startRotateFor(directionType::fwd, 2.47, rotationUnits::rev, 55,  velocityUnits::pct);
 FrontLeftBase.startRotateFor(directionType::fwd, 2.47, rotationUnits::rev, 55,velocityUnits::pct);
 BackRightBase.startRotateFor(directionType::fwd, 2.47, rotationUnits::rev, 55, velocityUnits::pct);
 BackLeftBase.rotateFor(directionType::fwd, 2.47, rotationUnits::rev, 55,velocityUnits::pct);
 vex::task::sleep(600);
 Claw.spin(directionType::fwd,100, velocityUnits::pct);
 vex::task::sleep(300);
 Claw.stop(hold);
